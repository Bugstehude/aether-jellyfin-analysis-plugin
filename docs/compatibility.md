...
| .NET SDK | 9.0.304, latest patch roll-forward | Reproducible local/CI build |
| EF Core SQLite | 9.0.11 | Matches Jellyfin 10.11.11 dependency line |
...
or executes raw SQL against Jellyfin's main database.
