...
The production plugin targets Jellyfin 12.0.0 and deliberately references
`Microsoft.EntityFrameworkCore.Sqlite.Core` 10.0.11. Jellyfin owns the process-wide managed and
...
The Jellyfin smoke test loads that exact archive into the digest-pinned official Jellyfin 12.0.0
